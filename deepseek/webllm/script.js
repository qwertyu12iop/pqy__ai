...
//web 1.0时代 html/css/js  服务器端java 返回的  js只做简单的交互
// web 2.0 时代 js 主动的请求后端服务器  动态页面 
// fetch('https://api.github.com/users/qwertyu12iop/repos')
// .then(res =>res.json())
// .then(data => {
//     //console.log(data)
...
const headers={
    ...
    //授权
    "Authorization":`Bearer sk-3140b945fddb43ae8c4ed8d201170835`
}
//请求体
const payload={
    model:'deepseek-chat',
